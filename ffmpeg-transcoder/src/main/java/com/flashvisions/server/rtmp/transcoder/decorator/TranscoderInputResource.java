...
public abstract class TranscoderInputResource implements IMedia,ITranscoderResource {

	private InterpretStrategy strategy;
	private IMedia media;
	
	
	public TranscoderInputResource(IMedia media){
		this.media = media;
		this.setStrategy(new DefaultInterpretStrategy());
	}
	
	public TranscoderInputResource(IMedia media, InterpretStrategy strategy){
		this.media = media;
